...
available at
`https://github.com/nyu-popl-sp26/homework-4-<YOUR-GITHUB-USERNAME>`.
Note that this may take a few minutes.

* Open a browser at `https://github.com/nyu-popl-sp26/homework-4-<YOUR-GITHUB-USERNAME>` with your Github username inserted at the appropriate place in the URL.
* Choose a place on your computer for your homework assignments to reside and open a terminal to that location.
* Execute the following git command: <br/>
  ```bash
  git clone https://github.com/nyu-popl-sp26/homework-4-<YOUR-GITHUB-USERNAME>.git hw04
  cd hw04
  ```
...
The problems that you should solve for this assignment are described in the file `hw04.pdf`.
